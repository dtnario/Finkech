    ...
    switch (currentStep) {
      case 1:
        return (
          <div>
            ...
            <h2 className="hrefHeader">Already have an account?
              <a href="/login" className="hrefText"> Sign in</a>
            </h2>
            <form onSubmit={nextStep}>
              ...
              <button  
              className={email? "LoginBubbleButton" : "DisabledLoginBubbleButton" }
              disabled={!email} 
              >
                Continue
              </button>
      ...
      case 2:
        return (
          ...
          <h1 style={{ marginBottom: '8px' }} className="mainHeader">password</h1>
          </div>
          ...
          <div>
            ...
            className={(password&&confirmPassword) 
              ...
              "LoginBubbleButton" : "DisabledLoginBubbleButton" }
      ...
      case 3:
        ...
        case 4:
          return (
            ...
            <h1 style={{ marginBottom: '8px' }} className="mainHeader">cash balance</h1>
            </div>
