...
import { API_GET_ACCOUNT, API_ADD_TRANSACTION, API_TRANSACTION_LIST , API_ADD_ACCOUNT ,  API_ACCOUNT_LIST , API_ADD_USER, API_ACCOUNT_USERS, API_GET_ACCOUNT_CATEGORIES} from './constants';
...
const MainScreen = () => {
  ...
  const getAccountUsers = async () => {
    try {
      ...
      const response = await fetch(API_ACCOUNT_USERS +'?account_id=' + body.accountid, {
        method: 'GET',
        headers: {
  ...
  const fetchTransactions = async (user) => {
    try {
      ...
      const response = await fetch(API_TRANSACTION_LIST 
  ...
  const calculateBalance = async () => {
    try {
    const response = await fetch(API_GET_ACCOUNT + 
      '?account_id=' + localStorage.getItem('account') +
      '&user_id=' + localStorage.getItem('token'),
        {
        method: 'GET',
  ...
  const updateCategories = async () => {
    try {
    const response = await fetch(API_GET_ACCOUNT_CATEGORIES + 
      '?account_id=' + localStorage.getItem('account') +
      '&user_id=' + localStorage.getItem('token'),
        {
        method: 'GET',
  ...
  const fetchAccounts = async () => {
    try {
      const response = await fetch(API_ACCOUNT_LIST + '?user_id=' 
  ...
  function CurrentStep() {
    switch (currentStep) {
        ...
        return (
          ...
          <div className='MainContainer'>
            ...
            <div className='NavPanelBubbleContainer'>
              <button style={{ textAlign: 'left' , paddingLeft:'24px' }} 
              ...
              <button style={{ textAlign: 'right', paddingRight:'24px' }} 
              className='NavPanelButton'
            ...
            <div className='AdaptiveGrid'>
              ...
              <div className='MobileSectionGrid'>
                ...
                <div className='HorizontalGrid6535'>
                  ...
                  <button onClick={moveToChooseAccount} 
                  className='AccountStatsContainer' style={{border:'none'}}>
                    ...
                    <div className='VerticalGrid'>
                      <div className='HorizontalGridAccountInfo'>
                        ...
                        height={16} 
                        /></div>
                        <h1 style={{fontSize:'12px' , color: '#D1D1D6'}} className='currencyHeaderHeavy'>{accountName}</h1>                      
                        <img 
                        src={StarIcon} 
                        alt="icon"
                        width={36} 
                  ...
                  <button className='AddAccountButton'
                    ...
                    <div style={{fontSize:'48px' , color : '#9747FF' , width : '80px' , height : '32px'}}>+</div>
                    <div style={{fontSize:'12px', width : '80px' , height : '32px'}}>AddAccount</div>
                  </button>
              ...
              <div className='TransactionsContainer'>
                ...
                <button onClick={moveToTransactionList} className="hrefTextMain">Show more</button>
              </div>
      ...
      case 2:
        return(
          <AddTransaction updateCategories = {updateCategories} categories = {categories} addTransaction={addTransaction} currencySymbol={getCurrencySymbol()}
      ...
      case 3:
        return(
          ...
          <div className='TransactionsContainer'>
                <TransactionFullList transactions={transactions} currencySymbol={getCurrencySymbol()} />
          </div>
        ...
        case 4:
          ...
          case 5:
            return(
              ...
              <h1 style={{ marginBottom: '8px' }} className="mainHeader">account</h1>
              </div>
    
              <div class="empty-back-button">
              &nbsp;
              </div>
            ...
            case 6:
              return(
                ...
                <div className='StatisticsFullContainer'>
                    <AccountList accounts={accounts} handleClick={handleChooseAccount} />
                </div>
